    ...
    <div class="space-y-2">
        ...
        <div
            ...
            <IntlTelInput
                ...
                class="w-full h-full text-sm leading-6 font-medium text-gray-700 placeholder:text-gray-400 invalid:text-red-400 placeholder:font-normal border-0 focus:ring-0 bg-transparent appearance-none [&::-webkit-search-cancel-button]:cursor-pointer"
            />
        ...
        <span v-if="errorText || inputError" class="scroll-to-error font-medium text-red-500 text-xs mt-1">
...
<script>
    ...
    export default {
        ...
        components: { Button, IntlTelInput, CustomPopover, CustomTooltip, LineSkeleton },
        props: {
            modelValue: {
