    ...
    <div class="select-none min-h-screen bg-gray-50 pt-8 p-4 sm:p-8 space-y-4 sm:space-y-6">
        ...
        <template v-if="showTable">
            ...
            <div class="flex justify-between">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <UsersRoundIcon size="48" stroke-width="1" class="text-gray-400" />
            ...
            <Table
                ...
                <template #body>
                    ...
                    <tr
                        :key="department.id"
                        @click.stop="onView(department)"
                        v-for="department in departments"
                        :class="[checkedRows[department.id] ? 'bg-blue-50' : 'bg-white hover:bg-gray-50', 'group cursor-pointer text-sm border-b border-gray-200']">
                            ...
                            <template v-if="column.name == 'Organization'">
                                <td class="whitespace-nowrap align-center pr-4 py-4">
                                    <div v-if="department.organization" class="flex items-center space-x-2">
                                        ...
                                        <div class="whitespace-nowrap">{{ department.organization.name }}</div>
                                    </div>
                                </td>
                            </template>
                        ...
                        <td class="h-16 pr-4 py-4 flex align-middle items-center space-x-2">
                            <Button type="bare" size="xs" :leftIcon="Pencil" leftIconSize="16" :action="() => showUpdateDepartmentModal(department)" />
                            <Button type="bareDanger" size="xs" :leftIcon="Trash2" leftIconSize="16" :action="() => showDeleteDepartmentModal(department)" />
                        </td>
        ...
        <div v-else class="select-none w-full flex justify-center py-16">
            <div class="max-w-sm w-full bg-white shadow-sm rounded-xl p-6 flex flex-col items-center text-center space-y-4 border border-dashed border-gray-200">
                <UsersRoundIcon size="48" class="text-gray-400" />
...
import { Plus, Pencil, Trash2, UsersRoundIcon } from 'lucide-vue-next';
...
export default {
    ...
    components: {
        ...
        AddDepartmentModal, UpdateDepartmentModal, DeleteDepartmentModal, DeleteDepartmentsModal, UsersRoundIcon
    },
    data() {
        return {
            Plus,
