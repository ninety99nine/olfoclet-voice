        ...
        <div class="w-60 bg-white border border-gray-500 rounded-sm py-4 space-y-2 hover:shadow hover:border-blue-500 transition-all">
            ...
            <div class="flex items-center justify-between px-4">
                <div class="flex items-center space-x-2">
                    <CircleCheckBig size="20"></CircleCheckBig>
...
<script>
    ...
    import { CircleCheckBig, Settings, CirclePlus } from 'lucide-vue-next';

    export default {
        components: { Handle, CircleCheckBig, Settings, CirclePlus },
        props: {
            data: {
                type: Object
            },
