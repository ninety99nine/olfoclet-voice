<template>
    <Modal
        ...
        approveText="Create Website"
        :approveAction="createWebsite"
        :approveLoading="isCreating"
        subheader="Add a new website to a knowledge base">
    ...
    methods: {
        ...
        async createWebsite(hideModal) {
            ...
            try {
                ...
                this.notificationState.showSuccessNotification('Website created');
                this.$emit('created');
                hideModal();
            } catch (error) {
                const message = error?.response?.data?.message || error?.message || 'Something went wrong trying to create the website';
