<template>
    <div class="flex items-center space-x-1">
        <div class="w-60 bg-white border border-gray-500 rounded-sm py-4 space-y-2 hover:shadow hover:border-blue-500 transition-all">
            ...
            <div class="px-4">
                <p class="text-sm">If caller has billing issue → Billing Path</p>
                <p class="text-sm">Else → Support Path</p>
            </div>
        </div>
...
import { GitBranch, Settings, CirclePlus } from 'lucide-vue-next';

export default {
    components: { Handle, GitBranch, Settings, CirclePlus },
    props: {
        data: {
            type: Object,
        },
